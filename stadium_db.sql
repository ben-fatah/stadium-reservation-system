...
--
-- Host: localhost    Database: stadium_db
-- ------------------------------------------------------
...
CREATE TABLE `bookings` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `bookings_ibfk_1` FOREIGN KEY (`stadium_id`) REFERENCES `stadiums` (`id`) ON DELETE CASCADE,
...
-- Dump completed on 2025-11-26 17:05:28
